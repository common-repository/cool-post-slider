...
?>
<div class="wrap ripsladmin">
<form action="" method="post">
	<input type="hidden" name="_ricpslanonce" value="<?php echo wp_create_nonce( 'ripsla-nonce' ); ?>" />
	<p><b>Type : </b>
...
if(isset($_POST['_ricpslanonce']) && wp_verify_nonce( $_POST['_ricpslanonce'], 'ripsla-nonce' )){
	if(isset($_POST['ptype'])){ $h = '';
		...
		echo "[postSlider type='".$type."' cat='".$cat."' tag='".$tag."' ordby='".$ob."' ord='".$ord."' count='".$count."' offset='".$os."' temp='".$tmp."' exrpt='".$exp."']";
	}
}
?>
